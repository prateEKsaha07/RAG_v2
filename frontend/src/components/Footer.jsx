            ...
            <div className='bg-black pt-20 px-4'>
                <footer className="bg-white w-full max-w-[1350px] mx-auto text-black pt-8 lg:pt-12 px-4 sm:px-8 md:px-16 lg:px-28 rounded-tl-3xl rounded-tr-3xl overflow-hidden">
                    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-6 gap-8 md:gap-12">
                        ...
                        <div className="lg:col-span-3 space-y-6">
                            <a href="https://prebuiltui.com" className="block">
                                <svg width="31" height="33" viewBox="0 0 31 33" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="m8.349 4.55 7.098 3.884 7.098-3.885M8.35 27.83v-7.755l-7.1-3.886m28.394 0-7.099 3.885v7.754M1.676 8.658l13.771 7.546 13.77-7.546M15.448 31.25V16.189m14.197 5.976V10.212c0-.524-.147-1.039-.424-1.492a3.1 3.1 0 0 0-1.154-1.093L17.024 1.65a3.3 3.3 0 0 0-1.577-.4 3.3 3.3 0 0 0-1.577.4L2.828 7.627A3.07 3.07 0 0 0 1.674 8.72a2.87 2.87 0 0 0-.424 1.492v11.953c0 .524.147 1.04.424 1.493s.675.83 1.154 1.092l11.042 5.977c.48.262 1.023.4 1.577.4a3.3 3.3 0 0 0 1.577-.4l11.042-5.977c.48-.262.877-.639 1.154-1.092s.423-.969.424-1.493" stroke="#262626" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                            </a>
                            <p className="text-sm/6 text-neutral-600 max-w-96">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Consequatur aliquam perferendis voluptatum corrupti ratione obcaecati est repellendus at! Perspiciatis commodi debitis repudiandae labore quas mollitia et voluptatum odio laboriosam voluptatem.</p>
                        ...
                        <div className="lg:col-span-3 grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 lg:gap-28 items-start">
                            ...
                            <div>
                                ...
                                <ul className="space-y-3 text-sm text-neutral-800">
                                    <li><a href="#" className="hover:text-neutral-700">RAG_v2</a></li>
                                    <li><a href="#" className="hover:text-neutral-700">Templates</a></li>
                                    <li><a href="#" className="hover:text-neutral-700">Components</a></li>
                    ...
                    <div className="max-w-7xl mx-auto mt-12 pt-4 border-t border-neutral-300 flex justify-between items-center">
                        <p className="text-neutral-600 text-sm">© 2026 RAG_v2</p>
