...
function LandingPage({ onGetStarted, onHome }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50/90 via-amber-50/70 to-orange-50/50 text-gray-800 overflow-x-hidden relative">
      ...
      >
        <div className="px-5 py-1.5 rounded-full bg-gradient-to-r from-rose-100/80 to-amber-100/80 backdrop-blur-sm border border-rose-200/30 text-xs mb-6 text-rose-700 font-medium shadow-sm">
        ...
        <p className="mt-6 text-gray-500 max-w-2xl text-base">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-10">
          <button
            ...
            className="px-7 py-3 rounded-xl bg-gradient-to-r from-rose-500 to-amber-500 hover:from-rose-600 hover:to-amber-600 text-white text-sm font-medium transition-all duration-300 shadow-lg shadow-rose-200/50 hover:shadow-xl hover:shadow-rose-300/50 hover:scale-[1.02] flex items-center gap-2"
          >
            Start Learning
          ...
          <button
            ...
            className="px-7 py-3 rounded-xl border border-rose-200/50 text-sm text-gray-600 hover:bg-white/50 transition-all duration-300 hover:shadow-lg hover:scale-[1.02] backdrop-blur-sm"
          >
            Explore Features
          </button>
        </div>
      ...
      <section className="relative z-10 px-6 py-16 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-rose-100/80 to-amber-100/80 backdrop-blur-sm border border-rose-200/30 text-rose-700 text-xs font-medium mb-4">
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                {/* Icon */}
                <div className={`w-9 h-9 rounded-lg bg-gradient-to-br ${feature.iconBg} flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/60 backdrop-blur-sm border border-rose-200/30 text-gray-600 text-[11px]">
            <Award className="w-3.5 h-3.5 text-rose-500" />
            <span>AI-Powered</span>
          </div>
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/60 backdrop-blur-sm border border-amber-200/30 text-gray-600 text-[11px]">
            <Clock className="w-3.5 h-3.5 text-amber-500" />
            <span>Real-time</span>
          </div>
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/60 backdrop-blur-sm border border-emerald-200/30 text-gray-600 text-[11px]">
      ...
      <section className="relative z-10 text-center py-16 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <button
            onClick={onGetStarted}
            className="mt-8 px-9 py-3 bg-gradient-to-r from-rose-500 to-amber-500 hover:from-rose-600 hover:to-amber-600 text-white text-sm rounded-xl font-medium transition-all duration-300 shadow-lg shadow-rose-200/50 hover:shadow-xl hover:shadow-rose-300/50 hover:scale-[1.02] flex items-center gap-2 mx-auto"
          >
            Get Started
            <ArrowRight className="w-4 h-4" />
          </button>
