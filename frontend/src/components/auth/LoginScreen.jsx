    ...
    <div className="min-h-screen bg-[#f7f3ee] flex">
        ...
        <div className="flex flex-col justify-between p-12 w-full h-full">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-2">
              {[
                { icon: BookOpen, title: "AI-powered answers", sub: "From your own notes" },
                { icon: Brain,    title: "Smart quizzes",      sub: "Track your performance" },
                { icon: BarChart3, title: "Personalized roadmaps", sub: "Adapted to your goals" },
              ].map((item) => {
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm space-y-6">
            ...
            <div className="space-y-3.5">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="text-[11px] tracking-[0.12em] uppercase text-[#8a7965]">
                    Password
                  </label>
                  <button
                    type="button"
                    className="text-[11px] text-[#8a7965] hover:text-[#5c1a1a] transition-colors"
                  >
                    Forgot password?
                  </button>
                </div>
          ...
          {/* Demo credentials */}
          <div className="bg-[#faf7f3] border border-[#e8dfd3] rounded-md px-4 py-2.5">
            <p className="text-[10px] text-center text-[#8a7965]">
              Demo: demo@ragv2.com / password123
            </p>
          </div>
        </div>
      </div>
