...
function UploadScreen({ onSuccess, onBack, onLogout, user }) {
  ...
  const fetchSubjects = async () => {
    ...
    try {
      ...
      // silent — don't spam the user if backend is cold
    } finally {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50/80 via-amber-50/60 to-orange-50/40">
      ...
      <div className="fixed top-0 right-0 w-96 h-96 bg-rose-200/20 rounded-full blur-3xl -z-10 pointer-events-none" />
      <div className="fixed bottom-0 left-0 w-80 h-80 bg-amber-200/20 rounded-full blur-3xl -z-10 pointer-events-none" />
      <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-orange-100/10 rounded-full blur-3xl -z-10 pointer-events-none" />
      ...
      <main className="max-w-4xl mx-auto px-6 lg:px-8 py-10 space-y-8 relative">
        ...
        <div className="flex items-center gap-4 animate-fadeUp">
          ...
          <div>
            <h1 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-rose-600 to-amber-600 bg-clip-text text-transparent">
              Upload Study Notes
            </h1>
            <p className="text-rose-500/80 mt-1 flex items-center gap-2 text-sm sm:text-base">
        ...
        {/* Upload Card */}
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg shadow-rose-200/20 border border-rose-200/30 p-6 sm:p-8 animate-fadeUp">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-500">
                Upload a Markdown (.md) knowledge base
              </p>
            </div>
          </div>
                  ...
                  {file ? (
                    <div className="flex items-center justify-center gap-3">
                      ...
                      <button
                        ...
                        className="relative z-20 p-1 rounded-full hover:bg-rose-100 transition-colors"
                      >
                    ...
                    <>
                      ...
                      <p className="text-gray-600">
                        Click or drag to upload .md file
                      </p>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg shadow-amber-200/20 border border-amber-200/30 p-6 sm:p-8 animate-fadeUp">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-500">
                Select from previously uploaded subjects
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="relative">
              <select
                ...
                className="w-full appearance-none bg-white/50 border border-amber-200/50 rounded-xl px-4 py-3 pr-12 focus:outline-none focus:ring-2 focus:ring-amber-400/50 focus:border-transparent transition-all duration-200 cursor-pointer disabled:opacity-50"
              >
                <option value="">
                  {subjectsLoading
                    ? "Loading subjects..."
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg shadow-rose-200/20 border border-rose-200/30 p-6 sm:p-8 animate-fadeUp">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-500">
                Tips for well-structured notes
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4 text-gray-700 text-sm">
            <p className="flex items-start gap-2">
              ...
              <span>
                Use <strong>#</strong> for units, <strong>##</strong> for
                chapters, <strong>###</strong> for subtopics
              </span>
            </p>
            <p className="flex items-start gap-2">
              <span className="text-amber-400 font-bold">•</span>
              <span>Keep one subject per file</span>
            </p>
            <p className="flex items-start gap-2">
              <span className="text-orange-400 font-bold">•</span>
              <span>Write clear, concise notes instead of huge paragraphs</span>
            </p>

            <div className="bg-gradient-to-r from-rose-50 to-amber-50 rounded-xl p-4 font-mono text-xs sm:text-sm whitespace-pre-line border border-rose-200/30 text-gray-700">
{`# Unit 1
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg shadow-amber-200/20 border border-amber-200/30 p-6 sm:p-8 animate-fadeUp">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-500">
                Tags are managed by the developer
              </p>
            </div>
          </div>

          <p className="text-gray-600 mb-5 text-sm">
            If you'd like additional tags or metadata added to your notes, feel
          ...
          <div className="bg-gradient-to-r from-rose-50/50 to-amber-50/50 rounded-xl p-4 flex flex-col sm:flex-row justify-between items-center gap-3 border border-rose-200/30">
            <span className="font-semibold text-gray-700 break-all flex items-center gap-2 text-sm">
            ...
            <button
              onClick={copyEmail}
              className="bg-gradient-to-r from-rose-500 to-amber-500 hover:from-rose-600 hover:to-amber-600 text-white px-5 py-2 rounded-lg font-medium transition-all duration-200 hover:shadow-lg hover:shadow-rose-200/50 flex items-center gap-2 text-sm whitespace-nowrap"
            >
